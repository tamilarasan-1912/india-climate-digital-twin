...
# Combine the instantaneous variables and precipitation.
...
# Select the Chennai grid point.
#
# ERA5 grid contains two latitude points and one longitude point.
# nearest() selects the grid cell closest to the requested location.
ds = ds.sel(
    latitude=13.05,
    longitude=80.25,
    method="nearest",
...
# Convert hourly records into daily aggregates.
daily = pd.DataFrame({
